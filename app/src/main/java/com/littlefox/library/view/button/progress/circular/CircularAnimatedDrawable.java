package com.littlefox.library.view.button.progress.circular;
...
class CircularAnimatedDrawable extends Drawable implements Animatable {
    ...
    public void draw(Canvas canvas) {
        ...
        Log.i("Circuler","startAngle : "+startAngle+", sweepAngle : "+sweepAngle+", mCurrentGlobalAngle : "+mCurrentGlobalAngle+", mModeAppearing : "+mModeAppearing);
    ...
    public void stop() {
        ...
        Log.i("Circuler","stop()");
        if(mObjectAnimatorAngle != null)
        {
            mObjectAnimatorAngle.end();
            mObjectAnimatorAngle = null;
        }

        if(mObjectAnimatorSweep != null)
        {
            mObjectAnimatorSweep.end();
            mObjectAnimatorSweep = null;
        }
    ...
    {
        Log.i("Circuler","==== currentSweepAngle : "+currentSweepAngle+", mCurrentSweepAngle : "+mCurrentSweepAngle);
        if(currentSweepAngle - mCurrentSweepAngle < 0)
        {
            Log.i("Circuler","toggleAppearingMode()");
            toggleAppearingMode();
        }
